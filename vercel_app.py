...
app.config['SECRET_KEY'] = os.getenv('SECRET_KEY', 'sgac-super-secret-key-2026')
app.config['JWT_SECRET_KEY'] = os.getenv('JWT_SECRET_KEY', 'jwt-super-secret-key-2026')
...
def get_all():
    ...
    try:
        ...
        return jsonify({
            ...
            'carousel': carousel, 'downloads': downloads,
            'departments': departments, 'site_config': site_config
        })
    except Exception as e:
        cur.close()
        conn.close()
